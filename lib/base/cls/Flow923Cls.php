...
class Flow923Cls
{
    ...
    public static function Add($pid, $tno, $tcontent, $tdate, $tattachments, $tmemo, $no, $proj, $stage, $signer, $owner, $comp, $date, $c1, $c2, $c3, $c4, $c5, $c6, $c7, $c8)
    {
        $rs = DB::db()->Fetch("
                INSERT INTO " . self::TABLE . "(pid, tno, tcontent, tdate, tattachments, tmemo, no, proj, stage, signer, owner, comp, date, c1, c2, c3, c4, c5, c6, c7, c8)
				VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
				RETURNING id
				", array($pid, $tno, $tcontent, $tdate, $tattachments, $tmemo, $no, $proj, $stage, $signer, $owner, $comp, $date, $c1, $c2, $c3, $c4, $c5, $c6, $c7, $c8));
        return $rs ['id'];
    }
