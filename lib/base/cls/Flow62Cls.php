...
class Flow62Cls
{
    ...
    public static function Add($pid, $no, $signer, $content, $date, $attachments, $comp, $date_ping, $items, $totals, $m11, $m12, $m13, $m21, $m22, $m23, $m31, $m32, $m33, $m41, $m42, $m43, $m51, $m52, $m53, $m61, $m62, $m63)
    {
        $rs = DB::db()->Fetch("
                INSERT INTO " . self::TABLE . "(pid, no, signer, content, date, attachments, comp, date_ping, items, totals, m11, m12, m13, m21, m22, m23, m31, m32, m33, m41, m42, m43, m51, m52, m53, m61, m62, m63)
				VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
				RETURNING id
				", array($pid, $no, $signer, $content, $date, $attachments, $comp, $date_ping, $items, $totals, $m11, $m12, $m13, $m21, $m22, $m23, $m31, $m32, $m33, $m41, $m42, $m43, $m51, $m52, $m53, $m61, $m62, $m63));
        return $rs ['id'];
    }
