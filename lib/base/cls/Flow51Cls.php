...
class Flow51Cls
{
    ...
    public static function Add($pid, $comp, $no, $signer, $date, $items, $totals, $v1c, $v1n, $v1d, $v2c, $v2n, $v2d, $v3c, $v3n, $v3d)
    {
        $rs = DB::db()->Fetch("
                INSERT INTO " . self::TABLE . "(pid, comp, no, signer, date, items, totals, v1c, v1n, v1d, v2c, v2n, v2d, v3c, v3n, v3d)
				VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
				RETURNING id
				", array($pid, $comp, $no, $signer, $date, $items, $totals, $v1c, $v1n, $v1d, $v2c, $v2n, $v2d, $v3c, $v3n, $v3d));
        return $rs ['id'];
    }
