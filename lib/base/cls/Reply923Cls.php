...
class Reply923Cls
{
    ...
    public static function Add($pid, $fid, $no, $content, $date, $proj, $stage, $signer, $signer_code, $owner, $owner_code, $comp, $c1, $c2, $c3, $c4, $c5, $c6, $c7, $c8, $uid, $act)
    {
        $rs = DB::db()->Fetch("
                INSERT INTO " . self::TABLE . "(pid, fid, no, content, date, proj, stage, signer, signer_code, owner, owner_code, comp, c1, c2, c3, c4, c5, c6, c7, c8, uid, act)
				VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
				RETURNING id
				", array($pid, $fid, $no, $content, $date, $proj, $stage, $signer, $signer_code, $owner, $owner_code, $comp, $c1, $c2, $c3, $c4, $c5, $c6, $c7, $c8, $uid, $act));
        return $rs ['id'];
    }
