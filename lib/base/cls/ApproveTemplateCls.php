<?php
class ApproveTemplateCls
{
	protected static $cache = 't_approve_template';
	...
	public static function Add($id, $approveobjectid, $cause, $method, $flow, $process, $act)
	{
		DB::db ()->Query ( "
				INSERT INTO t_approve_list(id, approveobjectid, cause, method, flow, process, act)
				VALUES(?,?,?,?,?,?,?)
				", array ( $id , $approveobjectid , $cause , $method , $flow , $process , $act ) );
