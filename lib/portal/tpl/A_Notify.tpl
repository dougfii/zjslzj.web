<script>
    $(function(){
        $('.read').click(function(){
            ...
            $.post('?m=Work&a=OnRead', {id:id}, function(ret){if(ret.code==1)layer.msg('已读', 1, function(){Refresh();});else layer.msg(ret.msg, 2, -1);}, 'json');
        });
    });
</script>
<div class="toolbar">
    <div class="tool clear"><span class="cap">消息通知（<?php echo $count; ?>）</span></div>
</div>
