...
<div class="toolbar">
    <div class="tool clear"><span class="cap">大型枢纽分部验收结论 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?></div>
</div>
