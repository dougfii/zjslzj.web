<script>
    $(function(){
        $('#add').click(function(){
            ...
            $.post('?m=Project&a=OnProjectFlow61', {id:$('#id').val(),comp:$('#comp').val(),no:$('#no').val(),signer:$('#signer').val(),date:$('#date').val()
...
<div class="toolbar">
    <div class="tool clear"><span class="cap">大型枢纽工程主要建筑物分部工程质量核定 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?></div>
</div>
<div class="panel paneltool">
    <div class="pagea4">
        <div class="pagea4info">
            <div class="center">大型枢纽工程主要建筑物分部工程质量核定</div>
            <table class="tx1">
