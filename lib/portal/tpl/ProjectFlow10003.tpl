...
<div class="toolbar">
    <div class="tool clear"><span class="cap">安全生产条件检查表 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?><a class="tooladd" href="javascript:" onclick="Printer('?m=Project&a=ProjectFlow1Print&id=<?php echo $rs['id']; ?>');">打印</a></div>
</div>
        ...
        <div class="pagea4info">
            ...
            <table style="border:#000 solid 1px;font-size:12px;border-top:0px;border-bottom:0px;">
                ...
                <tr style="border: #000 solid 1px;padding:5px;">
                    ...
                    <td style="text-align: center;border: #000 solid 1px;padding:5px;"><input type="radio" name="item1"/></td>
                    <td style="text-align: center;border: #000 solid 1px;padding:5px;"><input type="radio" name="item1"/></td>
                    <td style="text-align: center;border: #000 solid 1px;padding:5px;"><input type="radio" name="item1"/></td>
