...
<div class="toolbar">
    <div class="tool clear"><span class="cap">质量监督申报 - <批示></span><a class="tooladd back" href="javascript:;">返回</a></div>
</div>
<div class="panel paneltool pagebg">
    <div class="pagea4">
        <div class="pagea4info">
            <div class="pa4-caption1"><?php echo $gc; ?></div>
            <div class="center">徐水质监<?php echo $rs['no']; ?></div>
            <div class="pa4-redline"></div>
            <div class="pa4-title1">关于对<?php echo $name; ?>质量监督批复</div>
