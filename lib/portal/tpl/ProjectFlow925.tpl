<script>
    $(function(){
        $('#add').click(function(){
            $.post('?m=Project&a=OnProjectFlow925', {tno:$('#tno').val(),tcontent:$('#tcontent').val(),tdate:$('#tdate').val()
...
<div class="toolbar">
    <div class="tool clear"><span class="cap">政府验收 - 竣工验收 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?></div>
</div>
