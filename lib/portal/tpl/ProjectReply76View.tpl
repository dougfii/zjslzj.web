<div class="toolbar">
    <div class="tool clear"><span class="cap">单位工程验收鉴定书 - [批复]</span><a class="tooladd back" href="javascript:;">返回</a></div>
</div>
...
?>
        <div class="pagea4info">
            <div class="pa4-reply">关于对<?php echo $name; ?>单位工程验收鉴定书的批复</div>
