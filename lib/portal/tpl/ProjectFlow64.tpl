<script>
    $(function(){
        $('#add').click(function(){
            ...
            $.post('?m=Project&a=OnProjectFlow64', {id:$('#id').val(),name:$('#name').val(),no:$('#no').val(),signer:$('#signer').val(),date:$('#date').val()
            ,v1c:$('#v1c').val(),v1n:$('#v1n').val(),v1d:$('#v1d').val(),v2c:$('#v2c').val(),v2n:$('#v2n').val(),v2d:$('#v2d').val(),v3c:$('#v3c').val(),v3n:$('#v3n').val(),v3d:$('#v3d').val()
            ,total0:$('#total0').val(),total1:$('#total1').val(),total2:$('#total2').val(),total3:$('#total3').val(),total4:$('#total4').val()
    ...
    <div class="pagea4">
        <div class="pagea4info">
            ...
            <table class="tx1">
                ...
                <tfoot>
                    <tr><td colspan="4">单位工程共 <?php if($edit) echo '<input type="text" class="c" id="total0" size="5" value="' . $total0 . '" />'; else echo $total0; ?> 个，其中优良 <?php if($edit) echo '<input type="text" class="c" id="total1" size="5" value="' . $total1 . '" />'; else echo $total1; ?> 个，优良率 <?php if($edit) echo '<input type="text" class="c" id="total2" size="5" value="' . $total2 . '" />'; else echo $total2; ?> %，主要单位工程优良率 <?php if($edit) echo '<input type="text" class="c" id="total3" size="5" value="' . $total3 . '" />'; else echo $total3; ?> %，工程项目质量等级 <?php if($edit) echo '<input type="text" class="c" id="total4" size="5" value="' . $total4 . '" />'; else echo $total4; ?> 。</td></tr>
                </tfoot>
            </table>
