...
if(!empty($rs))
{
    ...
    if($rs["n0"]>0){
        ...
        echo '<div class="item">2. <a href="?m=Project&a=ProjectFlow10002List">安全生产组织机构管理网络</a><span class="state">' . ProjectStateCls::Name($rs["s10002"]) . '</span></div>';
        echo '<div class="item">3. <a href="?m=Project&a=ProjectFlow10003List">安全生产条件检查表</a><span class="state">' . ProjectStateCls::Name($rs["s10003"]) . '</span></div>';
