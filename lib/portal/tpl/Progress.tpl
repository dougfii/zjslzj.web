...
if(!empty($rs))
{
    ...
    if($rs["type"]==1){
        ...
        if($rs["n0"]>0){
            ...
            echo '<div class="item">5. <a href="?m=Project&a=ProjectFlow10005List">水利工程建设安全监督检查意见表</a><span class="state"></span></div>';
            echo '<div class="item">6. <a href="?m=Project&a=ProjectFlow10006List">水利工程建设参建单位安全评估表</a><span class="state">' . ProjectStateCls::Name($rs["s10006"]) . '</span></div>';
            ...
            echo '<div class="item">9. <a href="?m=Project&a=ProjectFlow10009List">水利工程建设安全评价申请书</a><span class="state">' . ProjectStateCls::Name($rs["s10009"]) . '</span></div>';
