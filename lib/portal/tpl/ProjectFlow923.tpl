<script>
    $(function(){
        $('#add').click(function(){
            $.post('?m=Project&a=OnProjectFlow923', {tno:$('#tno').val(),tcontent:$('#tcontent').val(),tdate:$('#tdate').val()
...
<div class="toolbar">
    <div class="tool clear"><span class="cap">政府验收 - 泵站机组启动验收 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?></div>
</div>
<div class="panel paneltool">
    ...
    <div class="pagea4">
        <div class="pagea4info">
            <div class="c"><?php if($edit) echo '<input type="text" class="pae4-text1" id="proj" value="' . $proj . '" />'; else echo $proj; ?> 工程 <?php if($edit) echo '<input type="text" class="pae4-text1" id="stage" value="' . $stage . '" />'; else echo $stage; ?> 阶段泵站机组启动验收</div>
            <br/><br/><br/><br/>
