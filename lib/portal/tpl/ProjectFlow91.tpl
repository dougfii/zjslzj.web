<script>
    $(function(){
        $('#add').click(function(){
            ...
            $.post('?m=Project&a=OnProjectFlow91', {id:$('#id').val(),no:$('#no').val(),signer:$('#signer').val(),date:$('#date').val()
...
<div class="toolbar">
    <div class="tool clear"><span class="cap">法人验收 - [<?php echo $state; ?>]</span><a class="tooladd back" href="javascript:;">返回</a><?php if($edit) echo '<a class="tooladd" id="add" href="javascript:;">提交</a>'; ?></div>
</div>
