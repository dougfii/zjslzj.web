...
//        $view->rs_new = $rs_new;
    ...
    public function OnReply()
    {
        ...
        if ($pass == 'backed') {
            $reply_id = ReplyClz::add($rs_work['org_id'], $rs_work['type_id'], $work_id, $node_id, $item_id, 0, $rs_item['no'] . ' - ' . $rs_item['time'], '', Json::Encode($datas), Json::Encode($attachments), ItemClz::StatusBacked, $this->Uid());
            ...
            $reply_id = ReplyClz::add($rs_work['org_id'], $rs_work['type_id'], $work_id, $node_id, $item_id, 1, $rs_item['no'] . ' - ' . $rs_item['time'], '', Json::Encode($datas), Json::Encode($attachments), ItemClz::StatusSuccess, $this->Uid());
