    ...
    <div class="a4-area" id="print_area">
        <div class="a4-block">
            ...
            <table class="a4-tbl-top">
                ...
                <tr><td class="k">分部工程名称</td><td><?php echo From::Text($edit, 'f1', $datas['f1'], ''); ?></td><td class="k">核备时间</td><td><?php echo From::Date($edit, 'f4', $datas['f4'], ''); ?></td></tr>
            </table>
            <table class="a4-tbl-middle">
                <tr><th rowspan="2">序号</th><th rowspan="2">重要隐蔽（关键部位）单元工程名称与编号</th><th colspan="2">核备等级</th></tr>
                ...
                <tr class="delitem">
                    <td class="item-no"></td>
                    <td class="c"><?php echo From::Text($edit, '', $datas['fa1'][$i], 'fa1', 40); ?></td>
