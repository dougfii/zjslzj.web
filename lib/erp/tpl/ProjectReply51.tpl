<script>
    $(function(){
        $('#allow').click(function(){
            $.post('?m=Project&a=OnProjectReply51', {fid:$('#fid').val(),no:$('#no').val(),content:$('#content').val(),date:$('#date').val()}, function (ret){if(ret.code==1)layer.msg('批复完成', 1, function(){history.back();});else layer.msg(ret.msg, 1);}, 'json');
        });
    });
</script>
<div class="toolbar">
...
<div class="panel paneltool">
    <div class="pagea4">
        <div class="pagea4info">
            ...
            <div class="pa4-title1">关于对<?php echo $name; ?>重要隐蔽（关键部位）单元工程核备的批复</div>
