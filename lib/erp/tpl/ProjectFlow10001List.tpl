...
<div class="panel paneltool">
    ...
    if(!empty($rl)){
        ...
        echo '</tr>';
        echo '<tr>';
        echo '<td><a href="?m=Project&a=ProjectFlow10001&pid=' . $pid . '">' . $rl['name'] . ' ' . $rl['time'] . '</a></td>';
    ...
    if(!empty($rs)){
        ...
        foreach($rs as $k => $v){
            echo '<tr>';
            echo '<td><a href="?m=Project&a=ProjectFlow10001&pid=' . $pid . '&id=' . $v['id'] . '">' . $v['name'] . ' ' . $v['time'] . '</a></td>';
