<script type="text/javascript">
	...
	$('#ok').click(function(){
		$.post('?m=System&a=OnGroupEdit', {id:$('#id').val(),fid:$('#fid').val(),name:$('#name').val(),company:$('#company').val()}, function (ret){if(ret.code==1)layer.msg('编辑成功', 1, function(){window.history.back();});else layer.msg(ret.msg, 1);}, 'json');
	});
});
</script>
<div class="toolbar">
	<div class="tool clear"><span class="cap">编辑组织</span></div>
</div>
<div class="sideorg">
...
<div class="panelgroup">
	...
	<table class="ti">
		<tr>
			...
			<td class="k">单位名称</td>
			<td class="v"><input type="text" id="company" class="r" value="<?php echo $rs['company']; ?>"/></td>
			<td class="k"></td>
			<td class="v"></td>
			<td class="k"></td>
			<td class="v"></td>
