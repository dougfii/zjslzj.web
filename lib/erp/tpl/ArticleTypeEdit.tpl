<script type="text/javascript">
	...
	$(function(){
		...
		$('#ok').click(function(){
			...
			$.post('?m=Article&a=OnArticleTypeEdit', {id:$('#id').val(),pid:$('#pid').val(),name:$('#name').val(),dir:dir,act:act}, function (ret){if(ret.code==1)layer.msg('编辑成功', 1, function(){window.history.back();});else layer.msg(ret.msg, 1);}, 'json');
		});
	});
</script>

<div class="toolbar">
	<div class="tool clear"><span class="cap">编辑分类</span></div>
</div>
<div class="sideorg">
...
<div class="panelgroup">
	...
	<table class="ti">
		<tr>
			...
			<td class="k">目录</td>
			<td class="v"><input type="checkbox" id="dir" <?php if($rs['dir']) echo 'checked'; ?> /> 显示</td>
			<td class="k">状态</td>
