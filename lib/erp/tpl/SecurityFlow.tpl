...
if(!empty($rs))
{
    ...
    if($rs["n0"]>0){
        ...
        echo '<div class="item">2. <a href="?m=Project&a=ProjectFlow10005List&pid=' . $pid . '">水利工程建设安全监督检查意见表</a><span class="state"></span></div>';
        echo '<div class="item">3. <a href="?m=Project&a=ProjectFlow10006List&pid=' . $pid . '">水利工程建设参建单位安全评估表</a><span class="state">' . ProjectStateCls::Name($rs["s10006"]) . '</span></div>';
        ...
        //echo '<div class="item">8. <a href="?m=Project&a=ProjectFlow10008List&pid=' . $pid . '">水利工程建设安全监督通知书</a><span class="state"></span></div>';
        echo '<div class="item">4. <a href="?m=Project&a=ProjectFlow10009List&pid=' . $pid . '">水利工程建设安全评价申请书</a><span class="state">' . ProjectStateCls::Name($rs["s10009"]) . '</span></div>';
        //echo '<div class="item">10. <a href="?m=Project&a=ProjectFlow10010List&pid=' . $pid . '">安全监督报告</a><span class="state">' . ProjectStateCls::Name($rs["s10010"]) . '</span></div>';
    }
    echo '</div>';
}
?>
