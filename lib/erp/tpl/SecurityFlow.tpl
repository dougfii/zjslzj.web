...
if(!empty($rs))
{
    ...
    if($rs["n0"]>0){
        ...
        echo '<div class="item">5. <a href="?m=Project&a=ProjectFlow10005List&pid=' . $pid . '">水利工程建设安全监督检查意见表</a><span class="state"></span></div>';
        ...
        echo '<div class="item">9. <a href="?m=Project&a=ProjectFlow10009List&pid=' . $pid . '">水利工程建设安全评价申请书</a><span class="state">' . ProjectStateCls::Name($rs["s10009"]) . '</span></div>';
