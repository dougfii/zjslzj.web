	...
	<table class="tl">
       ...
       if(!empty($rs)):
		...
		<tr>
			...
			<td class="fopr"><?php if($isAdmin) echo '<a href="?m=Work&a=WorkEdit&id=' . $v['id'] . '">编辑</a> '; ?><a href="#" class="del" did="<?php echo $v['id']; ?>">删除</a></td>
		</tr>
		<?php
            endforeach;
        endif;
