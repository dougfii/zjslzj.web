    ...
    <div class="a4-area" id="print_area">
        <div class="a4-block">
            ...
            <table class="a4-tbl-middle">
                <tr><th rowspan="2">序号</th><th rowspan="2">单位工程名称与编号</th><th colspan="2">核定等级</th></tr>
                ...
                <tr><td colspan="4">单位工程共<?php echo From::Text($edit, 'f14', $datas['f14'], '', 5); ?>个，其中优良<?php echo From::Text($edit, 'f15', $datas['f15'], '', 5); ?>个，优良率<?php echo From::Text($edit, 'f16', $datas['f16'], '', 5); ?>%，主要单位工程优良率<?php echo From::Text($edit, 'f17', $datas['f17'], '', 5); ?>%，工程项目质量等级<?php echo From::Text($edit, 'f18', $datas['f18'], '', 5); ?> 。</td></tr>
            </table>
