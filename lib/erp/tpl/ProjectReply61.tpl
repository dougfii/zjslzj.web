...
<div class="toolbar">
    <div class="tool clear"><span class="cap">大型枢纽分部验收结论 - [批复]</span><a class="tooladd back" href="javascript:;">返回</a></div>
</div>
<div class="panel paneltool">
    <div class="pagea4">
        <div class="pagea4info">
            ...
            <div class="pa4-title1">关于对<?php echo $name; ?>大型枢纽分部验收结论的批复</div>
