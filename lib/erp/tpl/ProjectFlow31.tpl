<script>
    $(function(){
        $('#deny').click(function(){
            $.post('?m=Project&a=OnProjectFlow31Deny', {pid:$('#pid').val(),fid:$('#fid').val(),content:$('#content').val()}, function (ret){if(ret.code==1)layer.msg('批复完成', 1, function(){location.reload();});else layer.msg(ret.msg, 1);}, 'json');
        });
...
<div class="panel paneltool">
    ...
    <div class="pagea4">
        <div class="pagedialog">
            ...
            <div class="pagedialog-buttons"><a href="?m=Project&a=ProjectReply31&fid=<?php echo $rs['id'] ?>" class="btn">同意</a><a href="javascript:;" class="btn" id="deny">驳回</a></div>
        </div>
    </div>
    <br/>
    <?php endif; ?>
    <div class="pagea4">
        <div class="pagea4info">
            <div class="center">单位工程外观质量评定表</div>
            <table class="tx1">
                <tr><td class="k">单位工程名称</td><td class="v"><?php echo $rs['name']; ?></td><td class="k">施工单位</td><td class="v"><?php echo $rs['comp']; ?></td></tr>
